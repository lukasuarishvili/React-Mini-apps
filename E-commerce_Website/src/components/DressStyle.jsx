...
function DressStyle() {
    return (
        <section className='w-full py-4 px-6 md:p-9  lg:p-12 flex flex-col gap-3 justify-center items-center font-roboto'>
            <h1 className=' text-4xl text-center md:lg:text-[48px] font-bold text-black'>BROWSE BY DRESS STYLE</h1>
            
            <div className="grid grid-rows-4 grid-cols-1 md:grid-rows-2 md:grid-cols-3 lg:grid-rows-2 lg:grid-cols-3 gap-5
             w-full bg-[#F0F0F0] p-10 rounded-2xl">
